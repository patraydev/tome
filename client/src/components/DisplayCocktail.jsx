...
function DisplayCocktail({ displayType, displayCocktail }) {
  ...
  return (
    <div className="cocktail-detail">
      ...
      <div className="detail ingredients">{displayCocktail.ingredients}</div>
      ...
      <div className="detail glass">{displayCocktail.glass ?`glass:     ${displayCocktail.glass}`: null}</div>
      <div className="detail ice">{displayCocktail.ice ?`ice:     ${displayCocktail.ice}`: null}</div>
      <div className="detail garnish">{displayCocktail.garnish ?`garnish:     ${displayCocktail.garnish}`: null}</div>
      <div className="detail method">{displayCocktail.method ?`method:     ${displayCocktail.method}`: null}</div>
